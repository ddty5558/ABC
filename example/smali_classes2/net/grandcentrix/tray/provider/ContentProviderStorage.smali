...
.field mObserver:Lnet/grandcentrix/tray/provider/ContentProviderStorage$TrayContentObserver;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Lnet/grandcentrix/tray/core/TrayStorage$Type;)V
    ...
    new-instance p1, Lnet/grandcentrix/tray/provider/TrayUri;

    iget-object p2, p0, Lnet/grandcentrix/tray/provider/ContentProviderStorage;->mContext:Landroid/content/Context;

    invoke-direct {p1, p2}, Lnet/grandcentrix/tray/provider/TrayUri;-><init>(Landroid/content/Context;)V

    iput-object p1, p0, Lnet/grandcentrix/tray/provider/ContentProviderStorage;->mTrayUri:Lnet/grandcentrix/tray/provider/TrayUri;

    new-instance p1, Lnet/grandcentrix/tray/provider/TrayProviderHelper;

    iget-object p2, p0, Lnet/grandcentrix/tray/provider/ContentProviderStorage;->mContext:Landroid/content/Context;

    invoke-direct {p1, p2}, Lnet/grandcentrix/tray/provider/TrayProviderHelper;-><init>(Landroid/content/Context;)V

    iput-object p1, p0, Lnet/grandcentrix/tray/provider/ContentProviderStorage;->mProviderHelper:Lnet/grandcentrix/tray/provider/TrayProviderHelper;
...
.method public annex(Lnet/grandcentrix/tray/core/TrayStorage;)V
    ...
    invoke-virtual {p1}, Lnet/grandcentrix/tray/core/TrayStorage;->getAll()Ljava/util/Collection;
    ...
    :cond_0
    invoke-virtual {p1}, Lnet/grandcentrix/tray/core/TrayStorage;->wipe()Z
...
.method public clear()Z
    ...
    invoke-virtual {p0}, Lnet/grandcentrix/tray/provider/ContentProviderStorage;->getModuleName()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lnet/grandcentrix/tray/provider/ContentProviderStorage;->getType()Lnet/grandcentrix/tray/core/TrayStorage$Type;
...
.method public declared-synchronized registerOnTrayPreferenceChangeListener(Lnet/grandcentrix/tray/core/OnTrayPreferenceChangeListener;)V
    ...
    iget-object p1, p0, Lnet/grandcentrix/tray/provider/ContentProviderStorage;->mObserverThread:Landroid/os/HandlerThread;
